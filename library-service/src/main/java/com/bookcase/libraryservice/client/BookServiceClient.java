package com.bookcase.libraryservice.client;

import com.bookcase.libraryservice.dto.BookDto;
import com.bookcase.libraryservice.dto.BookIdDto;
...
public interface BookServiceClient {
    ...
    ResponseEntity<BookDto> getBookById(@PathVariable(value = "bookId") String id);
